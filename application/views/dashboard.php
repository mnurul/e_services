	  ...
	  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
	    ...
	    <div class="carousel-inner">
	      <div class="carousel-item active">
	        <img src="<?= 'assets\img\pekerja.jpg' ?>" class="d-block w-100" alt="...">
	      </div>
	      <div class="carousel-item">
	        <img src="<?= 'assets\img\pekerja1.jpg' ?>" class="d-block w-100" alt="...">
	      </div>
	      <div class="carousel-item">
	        <img src="<?= 'assets\img\pekerja2.jpg' ?>" class="d-block w-100" alt="...">
	      </div>
	    </div>
	  ...
	  <div class="row text-center mt-4">
	    <?php foreach ($jasa as $js) : ?>
	      ...
	      <div class="card ml-3 mb-3" style="width: 16rem;">
	        <img src="<?php echo 'uploads/' . $js->gambar ?>" class="img-thumbnail" alt="...">
	        <div class="card-body">
